    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("Actions", "id")->format(function ($value, $row, $column) {
                ...
                $editBtn = '<a href="'. route('dashboard.patients.edit', $patient->id) .'" class="btn btn-warning btn-sm me-1"><i class="bi bi-pen"></i></a>';
                $viewBtn = '<a href="'. route('dashboard.patients.show', $patient->id) .'" class="btn btn-info btn-sm me-1"><i class="bi bi-list"></i> View</a>';
